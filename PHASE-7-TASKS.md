...
**DoD:** tidak ada credential/token atau data pengguna nyata pada artefak; API key Resend QA hanya berada di environment dan tidak digunakan aplikasi runtime; tidak ada webhook atau endpoint test-only, data uji tidak tersisa; tidak ada bypass authorization/domain command; seluruh flow yang relevan dengan F.6 hijau sebelum release.
