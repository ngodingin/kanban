...
/**
 * TASK-0.20.1 remediasi QA-CL-70 — bukti reproducible (tanpa secret eksternal):
 * keempat smoke consumer yang memakai helper hasil relokasi HARUS tetap
 * tereksekusi dengan exit 0 pada environment tanpa kredensial (graceful SKIP),
 * membuktikan import-path pasca-relokasi valid.
 */
const SCRIPTS = [
