...
export const membershipGroupAssignments = sqliteTable("membership_group_assignments", {
    id: text("id").primaryKey(),
...
export const membershipPermissionAssignments = sqliteTable("membership_permission_assignments", {
    id: text("id").primaryKey(),
    membershipId: text("membership_id")
        .notNull()
        .references(() => projectMemberships.id),
...
export const invitationGroupAssignments = sqliteTable("invitation_group_assignments", {
    id: text("id").primaryKey(),
...
export const projectDeprovisionJobs = sqliteTable("project_deprovision_jobs", {
    id: text("id").primaryKey(),
