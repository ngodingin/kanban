...
export async function revokeApiKey(globalClient: Client, input: {
    projectId: string;
    keyId: string;
...
export async function getApiKey(globalClient: Client, projectId: string, keyId: string): Promise<ApiKeySummary | null> {
