...
export const milestoneLabels = sqliteTable("milestone_labels", {
    id: text("id").primaryKey(),
    milestoneId: text("milestone_id")
        .notNull()
        .references(() => milestones.id),
...
export const boardLabels = sqliteTable("board_labels", {
    id: text("id").primaryKey(),
    boardId: text("board_id")
        .notNull()
        .references(() => boards.id),
...
export const cardMilestoneLabels = sqliteTable("card_milestone_labels", {
    cardId: text("card_id")
        .notNull()
        .references(() => cards.id),
...
export const cardBoardLabels = sqliteTable("card_board_labels", {
    cardId: text("card_id")
        .notNull()
        .references(() => cards.id),
    labelId: text("label_id")
