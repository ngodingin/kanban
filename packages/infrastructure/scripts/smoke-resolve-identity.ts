...
try {
    ...
    const identityBadCookie = await resolver.resolveIdentity(new Request("http://localhost:3000/api/v1/anything", {
    ...
    const identityExpired = await resolver.resolveIdentity(new Request("http://localhost:3000/api/v1/anything", {
