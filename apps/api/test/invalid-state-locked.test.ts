...
// TASK-0.15 goal 0.15.2 — regresi behavioral untuk titik ketiga (index.ts's
// try/catch /auth/*, Review-CL-17): INVALID_STATE terkunci 409 (C.2), MUST
// NOT dipasangkan 500. Static-scan regex rapuh untuk pola ini (struktur
// argumen bervariasi per titik) — perilaku AKTUAL lebih andal.
