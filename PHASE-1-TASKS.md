...
> Generated per [04-DELIVERY C.6](docs/04-DELIVERY.md). SOT version: 2.3.0 (lihat Closure Log Review-CL-02/05/06/07/08 untuk riwayat amandemen sejak generate).
...
- **Masih terbuka:** Review-CL-04 poin 3 (filter `GET /projects` di C.4 tidak terdefinisi) — belum diangkat lagi, tetap backlog non-blocking.
