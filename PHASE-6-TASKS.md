...
| 6.8.6 | 🔎 | [CL-47](#cl-47)<br>[CL-46](#cl-46)<br>[QA-CL-16](#qa-cl-16)<br>[CL-27](#cl-27) | 80 | P1 **[MODEL LEBIH KUAT WAJIB]** | **AC-028 (bagian kedua belum teruji).** Test: Given member Co-Owner Group (sudah terbukti dapat seluruh permission katalog, `baseline-groups.test.ts`); Then member itu MUST TETAP BUKAN Owner — assert eksplisit: tidak bisa revoke Owner asli, tidak muncul sebagai `ownerUserId`, dan Membership Co-Owner itu sendiri TETAP bisa di-revoke oleh Owner (Owner tidak kehilangan kontrol tertinggi). | [02-SPEC A.10](docs/02-SPEC.md) (BR-037); [04-DELIVERY AC-028](docs/04-DELIVERY.md) | — |
